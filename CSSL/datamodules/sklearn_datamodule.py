...
class SklearnDataset(Dataset):
    ...
    Example:
        ...
        >>> from CSSL.datamodules import SklearnDataset
        ...
...
class TensorDataset(Dataset):
    ...
    Example:
        >>> from CSSL.datamodules import TensorDataset
        ...
        >>> X = torch.rand(10, 3)
        >>> y = torch.rand(10)
...
class SklearnDataModule(LightningDataModule):
    ...
    Example:
        ...
        >>> from sklearn.datasets import load_boston
        >>> from CSSL.datamodules import SklearnDataModule
        ...
        >>> X, y = load_boston(return_X_y=True)
...
#     Example:
#
#         >>> from CSSL.datamodules import TensorDataModule
#         >>> import torch
#         ...
#         >>> # create dataset
#         >>> X = torch.rand(100, 3)
