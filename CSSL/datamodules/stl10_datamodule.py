...
from CSSL.datasets import ConcatDataset
from CSSL.transforms.dataset_normalizations import stl10_normalization
...
class STL10DataModule(LightningDataModule):  # pragma: no cover
    ...
    Example::
        ...
        from CSSL.datamodules import STL10DataModule
