...
class DummyDataset(Dataset):
    ...
    Example:
        >>> from CSSL.datasets import DummyDataset
...
class DummyDetectionDataset(Dataset):
    ...
    Example:
        >>> from CSSL.datasets import DummyDetectionDataset
        >>> from torch.utils.data import DataLoader
...
class RandomDictDataset(Dataset):
    ...
    Example:
        >>> from CSSL.datasets import RandomDictDataset
        >>> from torch.utils.data import DataLoader
...
class RandomDictStringDataset(Dataset):
    ...
    Example:
        >>> from CSSL.datasets import RandomDictStringDataset
        >>> from torch.utils.data import DataLoader
...
class RandomDataset(Dataset):
    ...
    Example:
        >>> from CSSL.datasets import RandomDataset
        >>> from torch.utils.data import DataLoader
        >>> ds = RandomDataset(10)
        >>> dl = DataLoader(ds, batch_size=7)
    """
