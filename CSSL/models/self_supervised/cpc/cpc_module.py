...
from CSSL.losses.self_supervised_learning import CPCTask
from CSSL.models.self_supervised.cpc.networks import cpc_resnet101
from CSSL.models.self_supervised.cpc.transforms import (
...
from CSSL.utils.pretrained_weights import load_pretrained
from CSSL.utils.self_supervised import torchvision_ssl_encoder
...
def cli_main():
    ...
    from CSSL.datamodules import CIFAR10DataModule
