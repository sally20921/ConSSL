...
from CSSL.losses.self_supervised_learning import FeatureMapContrastiveTask
from CSSL.models.self_supervised.amdim.datasets import AMDIMPretraining
from CSSL.models.self_supervised.amdim.networks import AMDIMEncoder
...
class AMDIM(pl.LightningModule):
    ...
    Example:
        ...
        >>> from CSSL.models.self_supervised import AMDIM
        ...
