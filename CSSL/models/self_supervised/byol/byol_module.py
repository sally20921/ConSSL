...
from CSSL.callbacks.byol_updates import BYOLMAWeightUpdate
from CSSL.models.self_supervised.byol.models import SiameseArm
from CSSL.optimizers.lars_scheduling import LARSWrapper
from CSSL.optimizers.lr_scheduler import LinearWarmupCosineAnnealingLR
...
def cli_main():
    from CSSL.callbacks.ssl_online import SSLOnlineEvaluator
    from CSSL.datamodules import CIFAR10DataModule, ImagenetDataModule, STL10DataModule
    from CSSL.models.self_supervised.simclr import SimCLREvalDataTransform, SimCLRTrainDataTransform
