...
from CSSL.metrics import mean, precision_at_k
from CSSL.models.self_supervised.moco.transforms import (
...
class MocoV2(pl.LightningModule):
    ...
    Example::
        from CSSL.models.self_supervised import MocoV2
        model = MocoV2()
        trainer = Trainer()
        trainer.fit(model)
...
def cli_main():
    from CSSL.datamodules import CIFAR10DataModule, SSLImagenetDataModule, STL10DataModule
