...
from CSSL.models.vision.image_gpt.gpt2 import GPT2
...
class ImageGPT(pl.LightningModule):
    ...
    **Default arguments:**
    ...
    Example::
        ...
        import pytorch_lightning as pl
        from CSSL.models.vision import ImageGPT
    ...
    .. code-block:: bash
        ...
        cd CSSL/models/vision/image_gpt
...
def cli_main():
    from CSSL.datamodules import FashionMNISTDataModule, ImagenetDataModule
